...
#library(xlsx)
library(readxl)
Airlines<-read_excel("E:\\Assignment\\18)Forecasting\\Airlines+Data.xlsx",1)
View(Airlines)
windows()
...
####################### Predicting new data #############################
library(readxl)
test_data<-read.csv("E:\\Assignment\\18)Forecasting\\Airlines_test_Data_excel.csv",1) # This file will be attached in the mail.
View(test_data)
